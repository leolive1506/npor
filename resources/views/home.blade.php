        ...
        <div class="mx-auto max-w-7xl py-8 sm:px-6 sm:py-10 lg:px-8">
            <div
                ...
                <h2 class="mx-auto max-w-2xl text-3xl font-bold tracking-tight text-white sm:text-4xl">
                    Entre no seu pelotão
                </h2>
                <p class="mx-auto mt-6 max-w-xl text-lg leading-8 text-gray-300">
                    Clique no em "procurar pelotão" para buscar o seu pelotão ou crie uma sala para seu pelotão
                </p>
                <div class="mt-10 flex items-center justify-center gap-x-6">
                    ...
                    <a href="{{ route('user-student-class.create') }}" class="text-sm font-semibold leading-6 text-white">

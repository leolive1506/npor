        ...
        <div>
            <div class="mx-auto max-w-7xl py-4 sm:px-6 sm:py-10 lg:px-8">
                <div
                    ...
                    <div>
                        <x-form.container.divider title="Preencha os campos ao lado" action="enter-stuent-class.register"
                            ...
                            <x-slot name="actions">
                                <a href="{{ route('enter-stuent-class.formLogin', $studentClass->code_class_id) }}"

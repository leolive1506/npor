                ...
                <div
                    ...
                    <div>
                        <x-form.container title="Escolha os participantes" method="POST" class="sm:mt-5"
                            action="group-participant.fragment-value.store">
                            <label class="relative inline-flex items-center cursor-pointer col-span-6">
                                <input type="checkbox" name="is_all_participants" class="sr-only peer" checked>
                                <div
                            ...
                            <div
                                class="col-span-6 p-4 max-w-md bg-white rounded-lg border shadow-md sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <div class="flow-root">
                                    <ul role="list" class="divide-y divide-gray-200 dark:divide-gray-700 max-h-60 overflow-y-auto">
                                        <li class="w-full">
                                            <button type="button" class="flex flex-1 w-full items-center space-x-4 p-3 sm:py-4 border active:scale-90 transition-transform border-transparent hover:border-gray-700 rounded">

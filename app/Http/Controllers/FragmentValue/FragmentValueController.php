...
namespace App\Http\Controllers\FragmentValue;

use App\Http\Controllers\Controller;
use App\Http\Requests\FragmentValue\CreateFragmentValueRequest;
...
class FragmentValueController extends Controller
{
    ...
    {
        return view('pages.fragment-value.index');
    }
    ...
    {
        return view('pages.fragment-value.create');
    }
